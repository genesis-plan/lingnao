...
| 许可 | 商业授权（非开源）；非商业用途免费，商业用途须取得书面授权，详见 LICENSE |
...
| `README.md` | 本模型卡与接入指南 |
| `package.json` / `LICENSE` | 可安装包定义 / 商业授权许可 |
...
- **非商业用途**（个人学习 / 研究 / 教学评测、非营利与教育机构内部使用、小微团队有限内部评估）**免费**，须保留 LICENSE 声明。
- **任何商业用途**（营利产品 / 服务、SaaS 或云部署对外提供能力、集成进商业发行物、再分发或转授权等）**均须事先取得版权方书面《商业授权协议》**，未授权禁止。
- 详情与商务授权申请见仓库根目录 **LICENSE** 文件。
- 可作为软著 / 专利材料与被动获客入口；但商业落地请先谈授权。
